...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-oc7mud8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-oc7mud8.containers.anotherwebservice.com/
...
```
git clone git@github.com:Diegoll7263/container-oc7mud8.git
cd container-oc7mud8
```
...
```
docker attach container-oc7mud8
```
